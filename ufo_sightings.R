...
#                  header = FALSE, 
#                  na.strings = "")
FilePath <- "ufo_awesome.tsv"
ufo <- read.delim(file.path(FilePath),
                  sep = "\t",
                  stringsAsFactors = FALSE,
                  header = FALSE, 
                  na.strings = "")
...
quick.hist # figure 1.5. Explanatory histogram of UFO data over time
...
quick.hist # figure 1.6. Histogram of subset UFO data over time (1990-2010)
