...
latex(anova(f), caption='Linear spline surface', file='',
      size='smaller', label='tab:anova-lsp')   # Table (*\ref{tab:anova-lsp}*)
perim <- with(acath,
...
latex(anova(f), caption='Cubic spline surface', file='',
      size='smaller', label='tab:anova-rcs') #Table (*\ref{tab:anova-rcs}*)
...
latex(anova(f), file='', size='smaller',
      ...
      label='tab:anova-ria') #Table (*\ref{tab:anova-ria}*)
...
latex(anova(f), caption='Linear interaction surface', file='',
      size='smaller', label='tab:anova-lia') #Table (*\ref{tab:anova-lia}*)
...
s <- summary(f.linia)   # Table (*\ref{tab:lrm-cholxage-confbar}*)
